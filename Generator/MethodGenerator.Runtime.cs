...
partial class MethodGenerator
{
    ...
    enum RuntimeType
    {
        ...
        None = 0b0000,
        /// <summary>
        /// Synchronous runtime needed.
        /// </summary>
        Sync = 0b0001,
        /// <summary>
        /// Asynchronous runtime needed.
        /// </summary>
        Async = 0b0010,
        /// <summary>
        /// Enumerable runtime needed.
        /// </summary>
        Enumerable = 0b0100,
        /// <summary>
        /// Asynchronous enumerable runtime needed.
        /// </summary>
    ...
    /// </summary>
    /// <param name="runtimeTypes">The types of runtimes that may be needed by the generated methods.</param>
    /// <param name="filename">The generated file name for the shared Piet interpreter runtime,
    /// or null if no runtime is needed.</param>
    /// <param name="source">The generated source code for the shared Piet interpreter runtime,
    /// or null if no runtime is needed.</param>
    /// <returns>True if the runtime source code is generated; otherwise, false.</returns>
    static bool TryMakePietRuntimeSource(RuntimeType runtimeTypes, out string filename, out string source)
    {
        filename = default!;
        source = default!;
        if (runtimeTypes <= 0) return false;
        filename = GeneratePietRuntimeFileName;
        source = PietRuntimeSource;
        return true;
    }
